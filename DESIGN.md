---
name: SentinelNet
description: A substation mimic panel for network operations — engraved laminate by day, SCADA console by night, where colour only ever means state.
colors:
  laminate: "#d4d7cf"
  plate: "#e6e7e1"
  recess: "#dcded7"
  ...
  seam-deep: "#46535c"
  ink-inverse: "#e8ebe6"
  ink-inverse-muted: "#a2acb2"
  ink-inverse-soft: "#909ba2"
  lamp-energised: "#2f8f4e"
  lamp-caution: "#b8791a"
  lamp-fault: "#c0392b"
  lamp-unpolled: "#7d848b"
  lamp-energised-dark: "#56c07a"
  ...
  conductor-c: "#2e8b57"
  conductor-d: "#6b4423"
  conductor-trace: "#7b3fb5"
  severity-critical: "#a3231a"
  severity-high: "#985806"
  severity-medium: "#6f6410"
  severity-low: "#2c6b3f"
typography:
  legend-hero:
